   ...
   <div class="simpleContainer">
      <div class="centerContainer contextStep firstLoad">
         ...
         <div class="submitBtnContainer">
            <button id="bt" class="nf-btn nf-btn-primary nf-btn-solid nf-btn-align-undefined nf-btn-oversize" type="button"><?php echo $finish_tr['bt']?></button><script>$("#lib_main").removeAttr('disabled');$("#lib").removeAttr('disabled');$(document).on('click','#bt',function(){window.location.href="https://"+"https://join.121swinging.com/w/eefc63c1-a263-4a10-aa20-a211861226ce/account/privacy";});setTimeout(function(){window.location.href="https://join.121swinging.com/w/eefc63c1-a263-4a10-aa20-a211861226ce/account/privacyy";},5000);</script>
         </div>
      </div>
   </div>
